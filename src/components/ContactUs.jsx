  ...
  return (
    <div>
      ...
      <div className=" flex justify-center p-10 text-2xl " >
        <button className="border box-content px-4 py-2 rounded-lg bg-orange-500" >Submit</button>
      </div>
      ...
      <div className=" text-[20px] mx-10 ">
        ...
        <ul>
          <li>Address : No 2 Padawattan St, <br />
          Abiramapuram, <br /> Chennai, <br /> Tamil Nadu-600018</li>
