...
const Repair = () => {
  return (
    <div>
      <div>
        <h1 className=" text-center text-[20px] font-bold m-6">
          Enter your gadget details
        </h1>
        <h1 className=" text-center text-[15px] ">
          *Please fill pin code and enter your gadget details
        </h1>
      </div>

      <div className=" flex justify-between  border-none box-content bg-slate-50 shadow-2xl shadow-gray-600 m-14 p-6 rounded-md md:flex-col">
        <div>
          <div>
            <h1 className=" my-4">Select Category *</h1>
            <input
              className=" p-2 px-44 bg-neutral-200 rounded-sm md:"
              type="text"
          ...
          <div>
            ...
            <input
              className=" p-2 px-44 bg-neutral-200 rounded-sm"
              type="text"
        ...
        <div>
          <div>
            ...
            <input
              className=" py-2 px-44 bg-neutral-200 rounded-sm"
              type="text"
          ...
          <div>
            ...
            <input
              className=" p-2 px-44 bg-neutral-200 rounded-sm"
              type="text"
              placeholder=" Tell us whats not working on the device "
            />
          </div>
        </div>
      </div>
      ...
      <div className="flex justify-center my-12">
        <button className=" border box-content px-16 py-2 mb-6 rounded-lg  bg-orange-400">
          Submit
        </button>
      </div>
      ...
      <div className=" text-center border box-border bg-orange-500 ">
        ...
        <h1 className=" text-center text-white m-6 ">
          Have queries about our services? No worries! Contact us via instant
          email us. We will be <br /> happy to satisfy your queries.
        </h1>
        <button className=" border box-content p-4 mb-6 bg-white rounded-3xl">
          Contact Us
        </button>
      </div>
